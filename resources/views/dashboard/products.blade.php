        ...
        <div class="w-full xl:w-4/5 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-4">
            <div class="flex flex-col items-center justify-center space-y-3">
                <div x-data="{ showBtn: false }" class="relative overflow-hidden" @mouseenter="showBtn = true" @mouseleave="showBtn = false">
                    <img class="w-[250px] h-[320px] transition duration-500" :class="showBtn ? 'scale-125' : ''" src="{{asset('storage/assets/img/ecommerce/product1.jpg')}}" alt="Product Name">
            ...
            <div class="flex flex-col items-center justify-center space-y-3">
                <div x-data="{ showBtn: false }" class="relative overflow-hidden" @mouseenter="showBtn = true" @mouseleave="showBtn = false">
                    <img class="w-[250px] h-[320px] transition duration-500" :class="showBtn ? 'scale-125' : ''" src="{{asset('storage/assets/img/ecommerce/product2.jpg')}}" alt="Product Name">
                    <div x-show="showBtn" x-transition.enter.duration.500ms="" x-transition.leave.duration.300ms="" class="absolute w-full h-full top-0 left-0 z-10 bg-black bg-opacity-40 flex items-end justify-center" style="display: none;">
                        <div class="mb-8 space-x-3">
                            <button class="bg-gray-100 hover:bg-primary text-primary hover:text-gray-100 p-2.5 rounded-full transition duration-200" title="Add To Wishlist">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <div class="flex flex-col items-center justify-center space-y-3">
                <div x-data="{ showBtn: false }" class="relative overflow-hidden" @mouseenter="showBtn = true" @mouseleave="showBtn = false">
                    <img class="w-[250px] h-[320px] transition duration-500" :class="showBtn ? 'scale-125' : ''" src="{{asset('storage/assets/img/ecommerce/product3.jpg')}}" alt="Product Name">
            ...
            <div class="flex flex-col items-center justify-center space-y-3">
                <div x-data="{ showBtn: false }" class="relative overflow-hidden" @mouseenter="showBtn = true" @mouseleave="showBtn = false">
                    <img class="w-[250px] h-[320px] transition duration-500" :class="showBtn ? 'scale-125' : ''" src="{{asset('storage/assets/img/ecommerce/product4.jpg')}}" alt="Product Name">
                    <div x-show="showBtn" x-transition.enter.duration.500ms="" x-transition.leave.duration.300ms="" class="absolute w-full h-full top-0 left-0 z-10 bg-black bg-opacity-40 flex items-end justify-center" style="display: none;">
                        <div class="mb-8 space-x-3">
                            <button class="bg-gray-100 hover:bg-primary text-primary hover:text-gray-100 p-2.5 rounded-full transition duration-200" title="Add To Wishlist">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <div class="flex flex-col items-center justify-center space-y-3">
                <div x-data="{ showBtn: false }" class="relative overflow-hidden" @mouseenter="showBtn = true" @mouseleave="showBtn = false">
                    <img class="w-[250px] h-[320px] transition duration-500" :class="showBtn ? 'scale-125' : ''" src="{{asset('storage/assets/img/ecommerce/product5.jpg')}}" alt="Product Name">
                    <div x-show="showBtn" x-transition.enter.duration.500ms="" x-transition.leave.duration.300ms="" class="absolute w-full h-full top-0 left-0 z-10 bg-black bg-opacity-40 flex items-end justify-center" style="display: none;">
                        <div class="mb-8 space-x-3">
                            <button class="bg-gray-100 hover:bg-primary text-primary hover:text-gray-100 p-2.5 rounded-full transition duration-200" title="Add To Wishlist">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <div class="flex flex-col items-center justify-center space-y-3">
                <div x-data="{ showBtn: false }" class="relative overflow-hidden" @mouseenter="showBtn = true" @mouseleave="showBtn = false">
                    <img class="w-[250px] h-[320px] transition duration-500" :class="showBtn ? 'scale-125' : ''" src="{{asset('storage/assets/img/ecommerce/product6.jpg')}}" alt="Product Name">
                    <div x-show="showBtn" x-transition.enter.duration.500ms="" x-transition.leave.duration.300ms="" class="absolute w-full h-full top-0 left-0 z-10 bg-black bg-opacity-40 flex items-end justify-center" style="display: none;">
                        <div class="mb-8 space-x-3">
                            <button class="bg-gray-100 hover:bg-primary text-primary hover:text-gray-100 p-2.5 rounded-full transition duration-200" title="Add To Wishlist">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <div class="flex flex-col items-center justify-center space-y-3">
                <div x-data="{ showBtn: false }" class="relative overflow-hidden" @mouseenter="showBtn = true" @mouseleave="showBtn = false">
                    <img class="w-[250px] h-[320px] transition duration-500" :class="showBtn ? 'scale-125' : ''" src="{{asset('storage/assets/img/ecommerce/product7.jpg')}}" alt="Product Name">
                    <div x-show="showBtn" x-transition.enter.duration.500ms="" x-transition.leave.duration.300ms="" class="absolute w-full h-full top-0 left-0 z-10 bg-black bg-opacity-40 flex items-end justify-center" style="display: none;">
                        <div class="mb-8 space-x-3">
                            <button class="bg-gray-100 hover:bg-primary text-primary hover:text-gray-100 p-2.5 rounded-full transition duration-200" title="Add To Wishlist">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <div class="flex flex-col items-center justify-center space-y-3">
                <div x-data="{ showBtn: false }" class="relative overflow-hidden" @mouseenter="showBtn = true" @mouseleave="showBtn = false">
                    <img class="w-[250px] h-[320px] transition duration-500" :class="showBtn ? 'scale-125' : ''" src="{{asset('storage/assets/img/ecommerce/product8.jpg')}}" alt="Product Name">
                    <div x-show="showBtn" x-transition.enter.duration.500ms="" x-transition.leave.duration.300ms="" class="absolute w-full h-full top-0 left-0 z-10 bg-black bg-opacity-40 flex items-end justify-center" style="display: none;">
                        <div class="mb-8 space-x-3">
                            <button class="bg-gray-100 hover:bg-primary text-primary hover:text-gray-100 p-2.5 rounded-full transition duration-200" title="Add To Wishlist">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <div class="flex flex-col items-center justify-center space-y-3">
                <div x-data="{ showBtn: false }" class="relative overflow-hidden" @mouseenter="showBtn = true" @mouseleave="showBtn = false">
                    <img class="w-[250px] h-[320px] transition duration-500" :class="showBtn ? 'scale-125' : ''" src="{{asset('storage/assets/img/ecommerce/product9.jpg')}}" alt="Product Name">
                    <div x-show="showBtn" x-transition.enter.duration.500ms="" x-transition.leave.duration.300ms="" class="absolute w-full h-full top-0 left-0 z-10 bg-black bg-opacity-40 flex items-end justify-center" style="display: none;">
                        <div class="mb-8 space-x-3">
                            <button class="bg-gray-100 hover:bg-primary text-primary hover:text-gray-100 p-2.5 rounded-full transition duration-200" title="Add To Wishlist">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <div class="flex flex-col items-center justify-center space-y-3">
                <div x-data="{ showBtn: false }" class="relative overflow-hidden" @mouseenter="showBtn = true" @mouseleave="showBtn = false">
                    <img class="w-[250px] h-[320px] transition duration-500" :class="showBtn ? 'scale-125' : ''" src="{{asset('storage/assets/img/ecommerce/product10.jpg')}}" alt="Product Name">
                    <div x-show="showBtn" x-transition.enter.duration.500ms="" x-transition.leave.duration.300ms="" class="absolute w-full h-full top-0 left-0 z-10 bg-black bg-opacity-40 flex items-end justify-center" style="display: none;">
                        <div class="mb-8 space-x-3">
                            <button class="bg-gray-100 hover:bg-primary text-primary hover:text-gray-100 p-2.5 rounded-full transition duration-200" title="Add To Wishlist">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <div class="flex flex-col items-center justify-center space-y-3">
                <div x-data="{ showBtn: false }" class="relative overflow-hidden" @mouseenter="showBtn = true" @mouseleave="showBtn = false">
                    <img class="w-[250px] h-[320px] transition duration-500" :class="showBtn ? 'scale-125' : ''" src="{{asset('storage/assets/img/ecommerce/product11.jpg')}}" alt="Product Name">
                    <div x-show="showBtn" x-transition.enter.duration.500ms="" x-transition.leave.duration.300ms="" class="absolute w-full h-full top-0 left-0 z-10 bg-black bg-opacity-40 flex items-end justify-center" style="display: none;">
                        <div class="mb-8 space-x-3">
                            <button class="bg-gray-100 hover:bg-primary text-primary hover:text-gray-100 p-2.5 rounded-full transition duration-200" title="Add To Wishlist">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <div class="flex flex-col items-center justify-center space-y-3">
                <div x-data="{ showBtn: false }" class="relative overflow-hidden" @mouseenter="showBtn = true" @mouseleave="showBtn = false">
                    <img class="w-[250px] h-[320px] transition duration-500" :class="showBtn ? 'scale-125' : ''" src="{{asset('storage/assets/img/ecommerce/product12.jpg')}}" alt="Product Name">
                    <div x-show="showBtn" x-transition.enter.duration.500ms="" x-transition.leave.duration.300ms="" class="absolute w-full h-full top-0 left-0 z-10 bg-black bg-opacity-40 flex items-end justify-center" style="display: none;">
                        <div class="mb-8 space-x-3">
                            <button class="bg-gray-100 hover:bg-primary text-primary hover:text-gray-100 p-2.5 rounded-full transition duration-200" title="Add To Wishlist">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
